...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false, ?isDebug:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'lego':
					tex = Paths.getSparrowAtlas('legoimp/LegoImp');
					frames = tex;
					animation.addByPrefix('idle', 'Idle', 14);
					animation.addByPrefix('singUP', 'Up', 35);
					animation.addByPrefix('singRIGHT', 'Right', 24);
					animation.addByPrefix('singDOWN', 'Down', 35);
					animation.addByPrefix('singLEFT', 'Left', 35);
	
					addOffset('idle');
					addOffset("singUP", -6, 0);
					addOffset("singRIGHT", 0, -17);
					addOffset("singLEFT", 400, 10);
					addOffset("singDOWN", 0, -30);
